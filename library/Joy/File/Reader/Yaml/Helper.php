<?php
/**
   * Joy_File_Reader_Yaml_Helper -- A Simple PHP YAML Class
   * @version 0.4.1
...
if (!function_exists('spyc_load')) {
  ...
  function spyc_load ($string) {
    return Joy_File_Reader_Yaml_Helper::YAMLLoadString($string);
  }
}
...
/**
   ...
   * Usage:
   * <code>
   *   $Joy_File_Reader_Yaml_Helper  = new Joy_File_Reader_Yaml_Helper;
   *   $array = $Joy_File_Reader_Yaml_Helper->load($file);
   * </code>
   * or:
   * <code>
   *   $array = Joy_File_Reader_Yaml_Helper::YAMLLoad($file);
   * </code>
   * or:
   * <code>
   ...
   * </code>
   */
class Joy_File_Reader_Yaml_Helper 
{
...
/**
 * Load a valid YAML string to Joy_File_Reader_Yaml_Helper.
 * @param string $input
 * @return array
 */
 ...
 /**
 * Load a valid YAML file to Joy_File_Reader_Yaml_Helper.
 * @param string $file
 * @return array
 */
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = Joy_File_Reader_Yaml_Helper::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  public static function YAMLLoad($input) {
    $Joy_File_Reader_Yaml_Helper = new Joy_File_Reader_Yaml_Helper;
    return $Joy_File_Reader_Yaml_Helper->__load($input);
  }
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = Joy_File_Reader_Yaml_Helper::YAMLLoadString("---\n0: hello world\n");
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
  ...
  public static function YAMLLoadString($input) {
    $Joy_File_Reader_Yaml_Helper = new Joy_File_Reader_Yaml_Helper;
    return $Joy_File_Reader_Yaml_Helper->__loadString($input);
  }
  ...
  public static function YAMLDump($array,$indent = false,$wordwrap = false) {
    $spyc = new Joy_File_Reader_Yaml_Helper;
